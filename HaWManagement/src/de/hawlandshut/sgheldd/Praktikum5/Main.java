...
public class Main {
	 ...
	 */
	private static void failNullRef() throws Exception {
	 ...
	 */
	private static void failDoubleDean() throws Exception{
	 ...
	 */
	private static void successNoMoreOtherDean() throws Exception{
	 ...
	 * Erwartete Ausgabe: true.
	 */
	private static void successSameDean() throws Exception{
		Professor wunderbar = new Professor("Dr. Ing.", true, "Juergen Wunderbar", "Am Lurzenhof 1", "1.1.1970");
	 ...
	 */
	private static void successNoMoreDean() throws Exception{
		Professor wunderbar = new Professor("Dr. Ing.", true, "Juergen Wunderbar", "Am Lurzenhof 1", "1.1.1970");
	 ...
	 */
	private static void failAmbiguousElement() throws Exception{
		UniversityManagement hawLandshut = new UniversityManagement(5, 4);
	 ...
	 */
	private static void failDoubleManagement() throws Exception{
